...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // Mobcoin: 3.5 days
static const int64 nTargetSpacing = 2.5 * 60; // Mobcoin: 2.5 minutes
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Israel time, 03/August/2014";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
